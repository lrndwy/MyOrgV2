...
func PUT(ctx *views.Context) error {
	return auth.RequireAuth(func(c *views.Context) error {
		...
		services.LogActivity(c.Request.Context(), user.ID, "update", "letter", id,
			"Memperbarui surat", c.Request.RemoteAddr)
...
func DELETE(ctx *views.Context) error {
	return auth.RequireAuth(func(c *views.Context) error {
		...
		services.LogActivity(c.Request.Context(), user.ID, "delete", "letter", id,
			"Menghapus surat", c.Request.RemoteAddr)
