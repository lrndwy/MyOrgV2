...
import (
	...
	app_admin_migrations "backend/app/admin/migrations"
...
func init() {
	...
	framework.RegisterRoute("GET", "/admin/migrations", app_admin_migrations.GET)
	...
	framework.RegisterRoute("DELETE", "/wallets/:id", app_wallets_id.DELETE)
}
